    ...
    return (
        <div className="fixed inset-0 bg-black/50 backdrop-blur-sm flex items-center justify-center p-4 z-50">
            <div className="bg-white rounded-3xl p-6 md:p-8 max-w-2xl w-full shadow-2xl">
                ...
                <div className="mb-6">
                    <h3 className="text-lg font-semibold text-gray-800 mb-2">URL</h3>
                    <a
                        href={tool.url}
                        target="_blank"
                ...
                <div className="flex gap-3">
                    ...
                    {user && (
                        <button
                            ...
                            className="px-6 py-3 bg-blue-100 text-blue-600 rounded-xl font-medium hover:bg-blue-200 transition-all flex items-center gap-2"
                        >
